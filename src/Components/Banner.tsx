  ...
  return (
    <div className="md:h-[729px] md:py-[140px] py-8 px-[20px] lg:px-[220px] bg-[#043873] md:flex items-center w-full">
      <div className="md:h-[361px] md:w-[656px] gap-14 mb-5">
        <div className="md:h-[238px]">
          <p className="text-white text-[45px] md:text-[64px] font-bold font-inter leading-[77.45px]">
            Get More Done with whitepace
          </p>
          <p className="text-base md:text-[18px] font-inter text-white">
      ...
      <div className="w-full h-[400px] lg:h-[549px] lg:w-[824px] bg-[#C4DEFD]"></div>
    </div>
  );
}
